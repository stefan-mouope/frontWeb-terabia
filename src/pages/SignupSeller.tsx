...
import { Sprout, User, Mail, Phone, MapPin, Lock, Upload, Loader2, ArrowLeft } from 'lucide-react';
        ...
        <Card className="p-8">
          <div className="flex flex-col items-center mb-8">
            ...
            <h2 className="text-xl font-semibold text-foreground">
              Inscription Vendeur / Agriculteur
            </h2>
            <p className="text-sm text-muted-foreground mt-2">
              Commencez à vendre vos produits directement aux consommateurs
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="city">Village / Ville</Label>
              <div className="relative">
